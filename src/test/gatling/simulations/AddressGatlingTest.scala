...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "fixedId":"SAMPLE_TEXT", "deleted":null, "addressLine1":"SAMPLE_TEXT", "addressLine2":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "zipCode":"SAMPLE_TEXT", "zip4Code":"SAMPLE_TEXT", "standardized":null, "latitude":"SAMPLE_TEXT", "longitude":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
