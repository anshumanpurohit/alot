(function() {
    ...
    angular
        .module('alotApp')
        .factory('CoverageTermDef', CoverageTermDef);

    CoverageTermDef.$inject = ['$resource', 'DateUtils'];

    function CoverageTermDef ($resource, DateUtils) {
        var resourceUrl =  'api/coverage-term-defs/:id';
